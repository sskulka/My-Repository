# -*- coding: utf-8 -*-
"""
Created on Thu Sep 30 15:06:31 2021
...
def dijkstra_occupancy(start_m, goal_m, gmap, movement='8N', occupancy_cost_factor=3):
    ...
    start_node_cost = 0
    start_node_estimated_cost_to_goal = start_node_cost
    front = [(start_node_estimated_cost_to_goal, start_node_cost, start, None)]
    #print("front type is: "+str(type(front)))
    ...
    while front:
        ...
        #print("element type is: "+str(type(element)))
        #print(element)
